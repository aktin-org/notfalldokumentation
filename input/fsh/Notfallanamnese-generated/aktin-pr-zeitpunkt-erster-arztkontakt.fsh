...
// http://www.aktin.org/fhir/StructureDefinition/aktin-pr-zeitpunkt-erster-arztkontakt
...
* ^url = "http://www.aktin.org/fhir/StructureDefinition/aktin-pr-zeitpunkt-erster-arztkontakt"
* insert Meta
* insert Version
* insert Publisher

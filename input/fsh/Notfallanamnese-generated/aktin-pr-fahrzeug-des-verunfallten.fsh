...
// http://www.aktin.org/fhir/StructureDefinition/aktin-pr-fahrzeug-des-verunfallten
...
* ^url = "http://www.aktin.org/fhir/StructureDefinition/aktin-pr-fahrzeug-des-verunfallten"
* insert Meta
* insert Version
* insert Publisher
